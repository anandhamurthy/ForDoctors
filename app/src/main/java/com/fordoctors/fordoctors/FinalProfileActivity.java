...
public class FinalProfileActivity extends AppCompatActivity {
    ...
    private TextView Edit_Profile_Name,Edit_Profile_Unique_Key, Edit_Profile_Phone_Number, Edit_Profile_Change_Profile_Image;
    private CircleImageView Edit_Profile_Image;
    private ImageView Edit_Profile_Back;
    private String Name;
    private EditText Edit_Profile_Age, Edit_Profile_Email_Id, Edit_Profile_Address,Edit_Profile_City,Edit_Profile_State,Edit_Profile_Country;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Edit_Profile_Unique_Key = findViewById(R.id.edit_profile_unique_key);
        ...
        mUsersDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Edit_Profile_Unique_Key.setText(user.getUnique_key());
                ...
                if (!Gender.isEmpty()){
                    if(Gender.equals("Male")) {
                        ...
                        Edit_Profile_Male.setVisibility(View.VISIBLE);
                        Edit_Profile_Female.setVisibility(View.GONE);
                        Edit_Profile_Others.setVisibility(View.GONE);
                    } else if(Gender.equals("Female")) {
                        Edit_Profile_Female.setChecked(true);
                        Edit_Profile_Female.setVisibility(View.VISIBLE);
                        Edit_Profile_Others.setVisibility(View.GONE);
                        Edit_Profile_Male.setVisibility(View.GONE);
                    } else{
                        Edit_Profile_Others.setChecked(true);
                        Edit_Profile_Others.setVisibility(View.VISIBLE);
                        Edit_Profile_Male.setVisibility(View.GONE);
                        Edit_Profile_Female.setVisibility(View.GONE);
                    }
                }
        ...
        Edit_Profile_Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isEmpty(Edit_Profile_Address.getText().toString(),
                        Edit_Profile_City.getText().toString(),
                        Edit_Profile_State.getText().toString(),
                        Edit_Profile_Country.getText().toString(),
                        Edit_Profile_Age.getText().toString(),Edit_Profile_Email_Id.getText().toString())) {

                    UpdateProfile(Edit_Profile_Address.getText().toString(),
                            Edit_Profile_City.getText().toString(),
                            Edit_Profile_State.getText().toString(),
                            Edit_Profile_Country.getText().toString(),
                            Edit_Profile_Age.getText().toString(),Edit_Profile_Email_Id.getText().toString());
                }else{
                    Toast.makeText(FinalProfileActivity.this, "Complete all details", Toast.LENGTH_SHORT).show();
                }
        ...
        Edit_Profile_Change_Profile_Image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CropImage.activity()
                        .setAspectRatio(1, 1)
                        .start(FinalProfileActivity.this);
            }
        });
    ...
    private void UpdateProfile(String address, String city, String state, String country, String age, String email) {
        ...
        Toast.makeText(FinalProfileActivity.this, "Successfully Updated!", Toast.LENGTH_SHORT).show();
    }
            ...
            mUploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(FinalProfileActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                    }
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(FinalProfileActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });

        } else {
            Toast.makeText(FinalProfileActivity.this, "No image selected", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private boolean isEmpty(String s, String toString, String string, String s1, String toString1, String string1) {
        if (s.isEmpty() || toString.isEmpty() || string.isEmpty() || s1.isEmpty() || toString1.isEmpty() || string1.isEmpty()) {
            Toast.makeText(FinalProfileActivity.this, "Complete All Details", Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    protected void onStart() {
        ...
        if (Name.equals("false")) {
            ...
            if (auth.getCurrentUser() != null) {
                ...
                mUsersDatabase.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (user.getVerified().equals("true")) {
                            Intent setupIntent = new Intent(FinalProfileActivity.this, MainActivity.class);
                ...
                startActivity(new Intent(FinalProfileActivity.this, Login.class));
                finish();
            }
        }
