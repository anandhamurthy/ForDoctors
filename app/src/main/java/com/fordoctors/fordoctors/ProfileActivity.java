...
public class ProfileActivity extends AppCompatActivity {
    ...
    private String Name;
    private EditText Edit_Profile_Name, Edit_Profile_Age, Edit_Profile_Unique_Key,Edit_Profile_Email_Id, Edit_Profile_Address,Edit_Profile_City,Edit_Profile_State,Edit_Profile_Country;
            ...
            public void onClick(View view) {
                ...
                if (isEmpty(Edit_Profile_Name.getText().toString(),Edit_Profile_Address.getText().toString(),
                    ...
                    UpdateProfile(Edit_Profile_Name.getText().toString(),
                            ...
                            Edit_Profile_State.getText().toString(),
                            Edit_Profile_Country.getText().toString(),
                            Gender, Edit_Profile_Age.getText().toString(),Edit_Profile_Email_Id.getText().toString(), Edit_Profile_Unique_Key.getText().toString());
                }else{
    ...
    private void UpdateProfile(String name, String address, String city, String state, String country, String gender,
                               String age, String email, String uni_key) {
